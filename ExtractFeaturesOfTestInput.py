...
def getTextInputArray():
    ...
    for imagePath in file_path:
        ...
        for c in cnts:
            ...
            test_user = getUsersOfSign.getSignOwnerOfTestInput(imagePath)
            print(test_user)
...
def getPredictInputArray():
    features_array =[]
    featuresarray = []
    root = tk.Tk()
    #file_path = ['E:\Level4_Project\WritingFeatures.csv']
    #file_path1 = filedialog.askopenfilenames(parent=root, title='Choose a file')
    file_path1 = 'E:/Level4_Project/sign_list/01001001.jpg',
    print(file_path1)
    file_path = root.tk.splitlist(file_path1)
