...
def signatureFeature_testInput(*args):
    #root = tk.Tk()
    root = main.win
    file_path = []
    features_array = []
    file_path = features_array
    file_path = ['E:\Level4_Project\WritingFeatures2.csv']
    ...
    for imagePath in file_path:
        ...
        for c in cnts:
            ...
            test_user = signatureFeature_testInput().getSignOwnerOfTestInput()
            print(test_user)
    ...
    # TrainData = loadFromCSV("'E:\Level4_Project\WritingFeatures.csv'", 0, 1, 10);
